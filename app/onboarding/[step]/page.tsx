...
import { ArrowLeft, ArrowRight, Users, Zap, Coffee, Home, Brain, Palette, Target, Music, Sparkles } from "lucide-react"
...
const questions: Question[] = [
  {
    ...
    icon: Users,
    options: [
      { text: "Hosting a big party with lots of friends", icon: Users, color: "from-pink-500 to-rose-500" },
      { text: "Having a small gathering with close friends", icon: Coffee, color: "from-purple-500 to-indigo-500" },
      { text: "Enjoying quiet time alone or with one person", icon: Home, color: "from-blue-500 to-cyan-500" },
      { text: "Exploring new places by myself", icon: Target, color: "from-green-500 to-emerald-500" },
    ],
  },
  {
    id: "decision-making",
    type: "slider",
    question: "When making important decisions, how much do you rely on logic vs. intuition?",
  ...
  },
  {
    ...
    icon: Zap,
    options: [
      { text: "Skydiving or bungee jumping", icon: Zap, color: "from-red-500 to-orange-500" },
      { text: "Trying a new restaurant in town", icon: Coffee, color: "from-yellow-500 to-amber-500" },
      { text: "Reading a book in a cozy café", icon: Home, color: "from-blue-500 to-indigo-500" },
      { text: "Planning a detailed itinerary for a trip", icon: Target, color: "from-purple-500 to-violet-500" },
    ],
  },
  {
    id: "work-style",
    ...
    icon: Home,
    images: [
      { src: "/placeholder.svg?height=200&width=300&text=Busy+Open+Office", label: "Busy Open Office", icon: Users },
      { src: "/placeholder.svg?height=200&width=300&text=Quiet+Library", label: "Quiet Library", icon: Home },
      { src: "/placeholder.svg?height=200&width=300&text=Coffee+Shop", label: "Bustling Coffee Shop", icon: Coffee },
      { src: "/placeholder.svg?height=200&width=300&text=Home+Office", label: "Cozy Home Office", icon: Target },
    ],
  },
  {
    id: "stress-response",
    ...
    icon: Sparkles,
    options: [
      { text: "Talking it out with friends or family", icon: Users, color: "from-pink-500 to-purple-500" },
      { text: "Going for a run or hitting the gym", icon: Zap, color: "from-orange-500 to-red-500" },
      { text: "Taking a long bath or meditation", icon: Home, color: "from-blue-500 to-cyan-500" },
      { text: "Organizing and making to-do lists", icon: Target, color: "from-green-500 to-teal-500" },
    ],
  },
  {
    id: "creativity-level",
  ...
  },
  {
    ...
    icon: Target,
    placeholder: "e.g., Travel the world, Start my own business, Make a difference...",
  },
]
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4 relative z-10">
                    ...
                    <span className="text-lg font-medium leading-relaxed">{option.text}</span>
                  </div>
                  {isSelected && (
        ...
        return (
          <div className="space-y-4">
            <Textarea
              ...
              rows={4}
            />
            <p className="text-slate-500 text-sm">Express yourself authentically - there are no wrong answers!</p>
          </div>
        )
                    ...
                    <div className="relative mb-4 overflow-hidden rounded-xl">
                      ...
                      <div
                        className={`absolute top-4 right-4 p-2 rounded-full transition-all duration-300 ${
                          isSelected ? "bg-white text-pink-500" : "bg-slate-800/80 text-white"
                        }`}
                      >
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white text-lg font-semibold">{Math.round(progress)}% Complete</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                {currentQuestion.subtitle && (
                  <p className="text-slate-400 text-lg leading-relaxed">{currentQuestion.subtitle}</p>
                )}
              </div>
            </div>
          </CardHeader>
